...
private struct MenuBarContent: View {
    ...
    var body: some View {
        Toggle("Scares Enabled", isOn: Binding(get: { state.settings.values.scaresEnabled }, set: state.setEnabled))
        ...
        Button("Pause for 1 Hour") { state.pauseOneHour() }.disabled(!state.settings.values.scaresEnabled)
        Divider()
        Button("Open Startle…") { openWindow(id: "main"); NSApp.activate() }
